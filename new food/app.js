   const products = [
        ...
        const renderFilterChips = () => {
          ...
          selectedCategory.forEach(category => {
            chipsHTML += `
              <div class="filter-chip flex items-center gap-1 bg-slate-700 text-white px-3 py-1 rounded-full text-sm cursor-pointer" 
        ...
        const renderCategories = () => {
          categoryFilterEl.innerHTML = categoryTitles
            .map(
              (category) => `
                <div class="category-item ${selectedCategory.includes(category) ? 'active' : ''}" 
